...
{
    public class ClienteEditarCrearVistaModelo
    {
        ...
        [JsonProperty(PropertyName = "contratos")]
        public virtual ICollection<ContratoVistaModelo> ContratosVistaModelo { get; set; }
    }
}
