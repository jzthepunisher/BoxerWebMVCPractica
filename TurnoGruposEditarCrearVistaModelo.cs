...
{
    public class TurnoGruposEditarCrearVistaModelo
    {
        ...
        [JsonProperty(PropertyName = "turnosGrupo")]
        public virtual ICollection<TurnoGrupoVistaModelo> TurnosGrupoVistaModelo { get; set; }
    }
}
